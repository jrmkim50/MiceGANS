...
# To restart: turn on cuda 10.0, cudnn 7.6, set start_resolution, edit resolution_batch_size, 
# and edit the saved model in PGGAN.__init__
        ...
        if self.strategy is not None:
            with self.strategy.scope():
                ...
                while 2**current_resolution<self.start_resolution:
                    self.add_resolution()
                    current_resolution+=1
        print("current_resolution: ", current_resolution)
