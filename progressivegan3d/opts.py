...
class Opts:
    def __init__(self):
        ...
        self.parser_train.add_argument('--gpus', default=['/gpu:0', '/gpu:1'], nargs='*', help='gpus to use') #, '/gpu:1'
        ...
        self.parser_generate.add_argument('--target_resolution', default=128, type=int, help='target resolution')
    ...
    def parse(self):
        ...
        if config.task=='train':
            ...
            if len(config.gpus)>1:
                ...
                config.resolution_batch_size = {4: 5, 8: 5, 16: 3, 32: 3, 64: 5, 128: 3} # per gpu
            else:
            ...
            #config.resolution_batch_size = {4: 2, 8: 2, 16: 2, 32: 2, 64: 2, 128: 1} # per gpu
            

            if config.kiters_per_transition == 0:
                config.kiters_per_transition = {4: 80, 8: 100, 16: 120, 32: 140, 64: 160, 128: 180}
                # set 64 to 5 kiters because I already trained 64
            else:
            ...
            if config.kiters_per_resolution == 0:
                config.kiters_per_resolution = {4: 80, 8: 100, 16: 120, 32: 140, 64: 160, 128: 180}
            else:
